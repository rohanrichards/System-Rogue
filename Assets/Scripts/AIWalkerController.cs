...
namespace CMF
{
	...
	public class AIWalkerController : Controller {
		...
		{
			AIMContext context = GetComponentInChildren<AIMContext>();
			Vector3 _velocity = Vector3.zero;
			//Debug.Log(context.DecidedDirection + " decidedValues[0]:" + context.DecidedValues[0]);
			_velocity += context.DecidedDirection * context.DecidedValues[0];
